...
int matriz_transicao[NUM_ESTADOS][NUM_SIMBOLOS+3] = { // +3 para considerar uma coluna para Letras, uma para Dígitos e uma para caracteres estrangeiros à linguagem
    // Estado 0
    {4, 1, 6, 10, 8, 9, 11, 15, 18, 19, 21, 20, 22, 24, 0, 0, 0, 0, 26, 27, 28, 0, 29},
    ...
    // Estado 6
    {25, 25, 25, 7, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25},
    ...
    // Estado 22
    {22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23, 22, 22, 30, 22, 22, 22, 22, 30, 22},
